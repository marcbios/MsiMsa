...
#setwd("")
date="02112020"
setwd("/homes/omo/public_html/effect_simulations/PostDoc/Manuscript2/Data/Simulated.F2/09F2/DifferentQTNs/F2.Traits.Adt20.Dom0.Epi4.Traits/")
home.dir <- "/homes/omo/public_html/effect_simulations/PostDoc/Manuscript2/Data/Simulated.F2/09F2/DifferentQTNs/F2.Traits.Adt20.Dom0.Epi4.Traits/"
Traitname <- "A20D0E4"
...
for(d in 1:length(F2.dirs)){
  ...
  print(paste("--------- Running Analysis....in simulated F2 Pop ", d, " !!!!!!!----------", sep = ""))
      ...
      write.table(Compliled.Results.Pop, paste("Compliled.Results.Pop.Simulated.F2.Pop.DifferentQTNs",d,Traitname,date,"csv", sep="."), quote=F, sep=",", row.names = F, col.names = T)
...
write.table(Compliled.Results.Pop.NULL, paste("Compliled.Results.Across.All.Simulated.F2.Pop.DifferentQTNs",Traitname,date,"csv", sep="."), quote=F, sep=",", row.names = F, col.names = T)
