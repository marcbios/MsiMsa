...
#setwd("")
date="02112020"
setwd("/homes/omo/public_html/effect_simulations/PostDoc/Manuscript2/Data/Simulated.F2/09F2/Diff.QTNs.Diff.Eff.MsiL/F2.Traits.Adt20.Dom0.Epi0.Traits/")
home.dir <- "/homes/omo/public_html/effect_simulations/PostDoc/Manuscript2/Data/Simulated.F2/09F2/Diff.QTNs.Diff.Eff.MsiL/F2.Traits.Adt20.Dom0.Epi0.Traits/"
Traitname <- "A20D0E0"
msi.dir <- "Msi_20_Add_QTN_1_Dom_QTN_1_Epi_QTN_h.2_0.6_reps_1/"
msa.dir <- "Msa_20_Add_QTN_1_Dom_QTN_1_Epi_QTN_h.2_0.6_reps_1/"
library(multtest)
library(gplots)
library(LDheatmap)
library(genetics)
...
for(d in 1:length(F2.dirs)){
  ...
  print(paste("--------- Running Analysis....in simulated F2 Pop ", d, " !!!!!!!----------", sep = ""))
      ...
      write.table(Compliled.Results.Pop, paste("Compliled.Results.Pop.Simulated.F2.Pop.Diff.QTNs.Diff.Eff.MsiL",d,Traitname,date,"csv", sep="."), quote=F, sep=",", row.names = F, col.names = T)
...
write.table(Compliled.Results.Pop.NULL, paste("Compliled.Results.Across.All.Simulated.F2.Pop.Diff.QTNs.Diff.Eff.MsiL",Traitname,date,"csv", sep="."), quote=F, sep=",", row.names = F, col.names = T)
